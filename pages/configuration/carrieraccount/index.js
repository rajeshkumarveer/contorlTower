...
const columns = [
  { id: "sno", label: "S.No." },
  { id: "caName", label: "Name" },
  { id: "caType", label: " Carrir Account Type" },
  ...
  const [rows, setrows] = useState([
    {
      ...
      caName: "Rajesh kumar",
      caType: "FEDEX",
      accountID: "7310100030765",
    },
    {
      id: 2,
      caName: "Dhanush",
      caType: "UPS",
      accountID: "7310100030769",
    },
  ]);
        ...
        <CardContent>
          ...
          >
            <DialogTitle sx={{ fontSize: "18px" }}>
              {" "}
              {isUpdate ? "Update" : "Add"} Carrier Account Details
            </DialogTitle>
            <Divider />
            <SimpleBar>
              <DialogContent>
                ...
                <CustomTextField
                  ...
                  fullWidth
                  variant="outlined"
                  value={dialogval.caName}
                  onChange={(e) => {
                    setdialogval({ ...dialogval, caName: e.target.value });
                  }}
                />
                <CustomFormLabel sx={{ mt: 1 }} htmlFor="Name">
                ...
                <CustomSelectField
                  ...
                  margin="dense"
                  id="caType"
                  value={dialogval.caType}
                  onChange={(e) => {
                    setdialogval({ ...dialogval, caType: e.target.value });
                  }}
                  fullWidth
                  variant="outlined"
                >
                ...
                <CustomTextField
                  ...
                  fullWidth
                  variant="outlined"
                  value={dialogval.accountID}
                  onChange={(e) => {
                    setdialogval({ ...dialogval, accountID: e.target.value });
                  }}
                />
              </DialogContent>
            </SimpleBar>
                      ...
                      <TableRow hover key={row.id}>
                        ...
                        >
                          <Box display="flex" alignItems="center">
                            ...
                            >
                              <Typography variant="h6">{row.caName}</Typography>
                            </Box>
                          </Box>
                        </TableCell>
                        <TableCell
                        ...
                        >
                          <Box display="flex" alignItems="center">
                            ...
                            >
                              <Typography variant="h6">{row.caType}</Typography>
                            </Box>
                          </Box>
                        </TableCell>
                        <TableCell
