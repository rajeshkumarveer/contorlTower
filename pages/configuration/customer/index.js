...
function index() {
  ...
  return (
    <div  >
      <Typography variant="h5" color="gray" sx={{ p: 3, pb: 1, pt: 1 }}  >
        Customer Details
      </Typography>
      <Card  >
        <CardContent>
          ...
          >
            <DialogTitle sx={{ fontSize: "18px" }}>
              {" "}
              {isUpdate ? "Update" : "Add"} Customer Details
            </DialogTitle>
            <Divider />
            <DialogContent>
              ...
              <CustomTextField
                ...
                fullWidth
                variant="outlined"
                value={dialogval.custname}
                onChange={(e) => {
                  setdialogval({ ...dialogval, custname: e.target.value });
                }}
              />
              <CustomFormLabel sx={{ mt: 1 }} htmlFor="Name">
                Customer ID
              ...
              <CustomTextField
                ...
                fullWidth
                variant="outlined"
                value={dialogval.custID}
                onChange={(e) => {
                  setdialogval({ ...dialogval, custID: e.target.value });
                }}
              />
              <CustomFormLabel sx={{ mt: 1 }} htmlFor="Name">
                Logo
                      ...
                      <TableRow hover key={row.id}>
                        ...
                        >
                          <Box display="flex" alignItems="center">
                            ...
                            >
                              <Typography variant="h6">{row.custID}</Typography>
                            </Box>
                          </Box>
                        </TableCell>
                        <TableCell
                        ...
                        >
                          <Box display="flex" alignItems="center">
                            ...
                            >
                              {/* <Typography variant="h6">{row.custlogo}</Typography> */}
                              <Image
                                src={row.custlogo}
                                width="70px"
                                height="70px"
