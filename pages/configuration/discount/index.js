...
const columns = [
  { id: "sno", label: "S.No." },
  { id: "dname", label: "Discount Name" },
  { id: "dCode", label: "Discount Code" },
  { id: "dpercent", label: "Discount Percentage (%)" },
...
function index() {
  const [mainrows, setmainrows] = useState([
    {
      id: 1,
      dname: " Wooden Product",
      dCode: "WP1",
      dpercent: "10%",
      customer: "Rajesh",
    },
    {
      dname: " Mixture Product",
      dCode: "MP1",
      dpercent: "9%",
      customer: "Dhanush",
    },
          ...
          >
            ...
            <DialogContent>
              ...
              <CustomTextField
                ...
                fullWidth
                variant="outlined"
                value={dialogval.dname}
                onChange={(e) => {
                  setdialogval({ ...dialogval, dname: e.target.value });
                }}
              />
              <CustomFormLabel sx={{ mt: 1 }} htmlFor="Name">
                Discount Code
              ...
              <CustomTextField
                ...
                fullWidth
                variant="outlined"
                value={dialogval.dCode}
                onChange={(e) => {
                  setdialogval({ ...dialogval, dCode: e.target.value });
                }}
              />
              <CustomFormLabel sx={{ mt: 1 }} htmlFor="Name">
                Discount Percentage
              ...
              <CustomTextField
                ...
                fullWidth
                variant="outlined"
                value={dialogval.dpercent}
                onChange={(e) => {
                  setdialogval({ ...dialogval, dpercent: e.target.value });
                }}
              />
              <CustomFormLabel sx={{ mt: 1 }} htmlFor="Name">
                Customer
              ...
              <CustomTextField
                ...
                onChange={(e) => {
                  setdialogval({ ...dialogval, customer: e.target.value });
                }}
              />
            </DialogContent>
            <DialogActions>
                      ...
                      <TableRow hover key={row.id}>
                        ...
                        >
                          <Box display="flex" alignItems="center">
                            ...
                            >
                              <Typography variant="h6">{row.dname}</Typography>
                            </Box>
                          </Box>
                        </TableCell>
                        <TableCell
                        ...
                        >
                          <Box display="flex" alignItems="center">
                            ...
                            >
                              <Typography variant="h6">{row.dCode}</Typography>
                            </Box>
                          </Box>
                        </TableCell>
                        <TableCell
