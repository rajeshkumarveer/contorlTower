...
function index() {
  const pList = [
    ...
    {
      id: "p5",
      label: "Kids sofas and armchairs",
    },
    {
      id: "p6",
      label: "Kids Bathroom",
        ...
        <CardContent>
          ...
          >
            <DialogTitle sx={{ fontSize: "18px" }}>
              {" "}
              {isUpdate ? "Update" : "Add"} Product Category Details
            </DialogTitle>
            <Divider />
            <DialogContent>
              ...
              <Box>
                ...
                <Autocomplete
                  ...
                  defaultValue={isUpdate ? dialogval.productlist : []}
                  fullWidth
                  // value={row.access}
